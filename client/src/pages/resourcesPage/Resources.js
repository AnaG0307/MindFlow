    ...
    <Sidebar />
      <Container>
        <Row>
          ...
          <Col xs={12} lg={10} style={{ paddingLeft: 0, marginLeft: 500}}>
            <div className="rightcols">
              <Resources />
            </div>
          </Col>
          <Col xs={10} lg={8} style={{ paddingLeft: 0, marginLeft: 500 }}>
            <div>
        ...
        <p className="pparagraph"> Helpful articles, blogs and personal experiences and tips from young people and our MindFlow team.
       </p>
       </div>
     <div className="Resources">
       <h3 className="paragraph"><a href="https://www.nhs.uk/nhs-services/mental-health-services/" target="_blank" rel="noreferrer"><img src={Mentalhealth} alt= "mental-health" className="mental-image"/></a>Mental Health</h3>
         <p className="pparagraph"> Start or join a conversation with our friendly MindFlow community.
        </p>
         </div>
         <div className="Resources">
        ...
        <p className="pparagraph"> Find some local therapists in your area to receive extra counselling.
        </p>   
          </div>
          </div>
          </Col>
